...
def get_scheduler(optimizer, opt, **kwargs):
    ...
    if opt.lr_policy == 'lambda':
        ...
        scheduler = lr_scheduler.OneCycleLR(optimizer, max_lr=0.001, steps_per_epoch=kwargs['len_train'], epochs=opt.n_epochs, cycle_momentum=True, verbose=True,div_factor=10000)
    else:
